    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                @if(Auth::user())
                    <form action="{{ url('/comment-image/' . $image->id) }}" method="POST">
                        {{ csrf_field()  }}
                        <div style="margin:0" class="form-group{{ $errors->has('image_' . $image->id .'_comment_content') ? ' has-error' : '' }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-11" style="padding-left: 5px;">
                                    ...
                                    <input class="form-control" value="{{ old('image_' . $image->id .'_comment_content') }}" placeholder="Napisz komentarz..." name="image_{{ $image->id }}_comment_content" style="padding-left:15px;width: 100%; margin-top: 5px; border-radius: 15px;" name="" id="" rows="1">
                                </div>
