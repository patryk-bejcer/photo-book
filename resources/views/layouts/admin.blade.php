            ...
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li {{ (Request::is('*charts') ? 'class="active"' : '') }}>
                        <a href="{{ url ('admin/users') }}"><i class="fa fa-users fa-fw"></i> Użytkownicy</a>
                        <!-- /.nav-second-level -->
                    </li>
                    <li {{ (Request::is('*tables') ? 'class="active"' : '') }}>
                        <a href="{{ url ('admin/roles') }}"><i class="fa fa-table fa-fw"></i> Role</a>
                    </li>
                    <li {{ (Request::is('*forms') ? 'class="active"' : '') }}>
                        <a href="{{ url ('admin/permissions') }}"><i class="fa fa-edit fa-fw"></i> Uprawnienia</a>
                    </li>
                    <li >
