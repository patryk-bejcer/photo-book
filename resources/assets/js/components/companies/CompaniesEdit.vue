...
<script>
    export default {
        mounted() {
            ...
            app.companyId = id;
            axios.get('http://localhost/gallery-portal/public/api/v1/companies/' + id)
                .then(function (resp) {
        ...
        methods: {
            saveForm() {
                ...
                axios.patch('http://localhost/gallery-portal/public/api/v1/companies/' + app.companyId, newCompany)
                    .then(function (resp) {
                        app.$router.replace('/');
                    })
                    .catch(function (resp) {
